...
The gap between ``resolved on paper'' and ``actually resolved'' is enormous --- and no one is measuring it.
...
Think of it as a Digital Chief of Staff --- it handles the operational complexity of running a constituency office so the representative can focus on actual governance.
\end{tcolorbox}
...
Vidhayak-Mitra  & Legislative research --- summaries of bills, policy analysis, talking points \\
...
\vspace{0.5em}
Together, these modules give every elected representative the operational infrastructure that only well-funded national politicians currently have access to --- at a fraction of the cost.
...
\begin{tabularx}{\linewidth}{lX}
\toprule
\textbf{Piyush Zaware} & Co-Founder \& CTO. MPP candidate at University of Chicago Harris (Data Analytics). Background in econometrics, ML, and data engineering. \\[4pt]
\textbf{Joe}           & Co-Founder \& COO. MIS and technology background. Leads product operations, user acquisition, and systems design. \\
\bottomrule
\end{tabularx}

\vspace{0.5em}
We are currently participating in the \textbf{Social New Venture Challenge (SNVC) 2026} at the University of Chicago Booth School of Business, building toward a live prototype demo in Spring 2026.
...
{\small Interested? Reach out at \textbf{piyush@pollity.in}}\\[0.2em]
{\small\color{gray} Pollity.in \textbar{} SNVC 2026 \textbar{} University of Chicago}
\end{center}
